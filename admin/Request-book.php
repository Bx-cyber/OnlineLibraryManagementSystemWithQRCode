...
<head>
    ...
    <title>Online Library Management System | Requested Books</title>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT StudentID,StudName,BookName,AuthorName,ISBNNumber,BookPrice from tblrequestedbookdetails";
