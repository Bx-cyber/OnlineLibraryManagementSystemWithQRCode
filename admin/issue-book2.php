...
$bookid=$_POST['bookid'];
$sql="INSERT INTO  tblissuedbookdetails(StudentID,BookId) VALUES(:studentid,:bookid);update tblbooks set IssuedCopies = IssuedCopies+1 where ISBNNumber=:bookid or id=:bookid;";
