...
header('location:request-a-book.php');
  ...
  {
	$sql="INSERT INTO tblrequestedbookdetails(StudentID,StudName,BookName,AuthorName,ISBNNumber,BookPrice) VALUES(:StudentID,:StudName,:BookName,:AuthorName,:ISBNNumber,:BookPrice)";
	$query = $dbh->prepare($sql);
	$query->bindParam(':StudentID',$StudentID,PDO::PARAM_STR);
